...
public class UnityEngine_ParticleSystemWrap
{
	...
	static int get_enableEmission(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index enableEmission on a nil value");
		}
	}
	...
	static int get_emissionRate(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index emissionRate on a nil value");
		}
	}
